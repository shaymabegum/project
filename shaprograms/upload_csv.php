...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["csvFile"])) {
    ...
    // Fetch and display the updated allocations from faculty_allocations table
    ...
    $sql = "SELECT date, slot, name FROM faculty_allocations";
    $result = $conn->query($sql);

    echo "<h1>Faculty Allocations</h1>";
    echo "<table border='1'>
            <tr>
                <th>Date</th>
                <th>Slot</th>
